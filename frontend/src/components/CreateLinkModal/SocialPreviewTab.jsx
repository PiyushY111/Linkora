...
export default function SocialPreviewTab({ formData, domain, actions }) {
    ...
    <div className="space-y-4">
      <div className="rounded-xl border border-ink-700 bg-ink-950 p-3.5 space-y-1">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-paper-100">Social Preview & OpenGraph Customization</span>
        </div>
      ...
      <div className="space-y-2 pt-2">
        ...
        <div className="overflow-hidden rounded-xl border border-ink-700 bg-ink-900 shadow-md">
          ...
          <div className="p-3.5 space-y-1">
            <div className="text-[10px] uppercase font-mono text-paper-500">{domain || 'linkora.dev'}</div>
