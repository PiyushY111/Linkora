export default function TargetingTab({ formData, actions }) {
  return (
    <div className="space-y-4">
      <div className="rounded-lg border border-ink-700 bg-ink-950 p-3.5 space-y-1">
        <span className="text-xs font-semibold text-paper-200">Mobile Deep Linking & OS Routing</span>
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          onChange={(e) => actions.setField('iosRedirect', e.target.value)}
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          onChange={(e) => actions.setField('androidRedirect', e.target.value)}
          className="input font-mono text-xs"
        />
      </div>
    </div>
