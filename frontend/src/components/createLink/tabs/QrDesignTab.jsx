...
/** QR code styling with a live preview. */
export default function QrDesignTab({ formData, setFormData, computedDestinationUrl, qrViewerRef, lightBackdrop, setLightBackdrop }) {
  return (
