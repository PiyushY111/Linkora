...
/** Destination URL, alias, category, title, tags and description. */
export default function GeneralTab({ formData, setFormData, domain, generateRandomAlias, handleAddTag, removeTag }) {
  return (
