import { User as UserIcon, BarChart3, CheckCircle2, Clock, Check, Save, Sparkles } from 'lucide-react';
import SettingsTabPanel from './SettingsTabPanel';
import { AVATAR_COLORS } from './settingsConstants';

function AvatarPicker({ avatarColor, setAvatarColor, userInitial }) {
...
function AccountTelemetryCard({ user }) {
  return (
...
export default function ProfileTab({ user, profile }) {
  const { name, setName, bio, setBio, avatarColor, setAvatarColor, isSavingProfile, handleSaveProfile } = profile;
    ...
    <SettingsTabPanel>
      ...
      <div className="panel p-6">
        ...
        <form onSubmit={handleSaveProfile} className="mt-6 space-y-6">
          ...
          <AvatarPicker avatarColor={avatarColor} setAvatarColor={setAvatarColor} userInitial={userInitial} />
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={500}
            />
            <div className="mt-1 text-right text-[11px] text-paper-500">{bio.length}/500 characters</div>
          </div>
      ...
      <AccountTelemetryCard user={user} />
    </SettingsTabPanel>
  );
}
