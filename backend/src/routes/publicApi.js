...
// keep writing.
const canReadLinks = requirePermission('links:read');
const canWriteLinks = requirePermission('links:write');
const canReadAnalytics = requirePermission('analytics:read');

// Links Management
v1.get('/links', requireScope('links:read'), canReadLinks, listLinks);
v1.post('/links', requireScope('links:write'), canWriteLinks, createLink);
v1.get('/links/:code', requireScope('links:read'), canReadLinks, getLink);
...
// Link Analytics
v1.get('/links/:code/analytics', requireScope('analytics:read'), canReadAnalytics, getLinkAnalytics);
