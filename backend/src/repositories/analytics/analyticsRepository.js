 ...
 *   Creates collections/indexes; idempotent. Called at process startup.
 * @property {(events: ClickEventRecord[], options?: { countLinkClicks?: boolean }) => Promise<{ applied: ClickEventRecord[] }>} recordClicks
